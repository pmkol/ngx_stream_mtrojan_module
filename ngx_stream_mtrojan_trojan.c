...
int
ngx_stream_trojan_parse_addr(const uint8_t *buf, size_t len, ngx_stream_mtrojan_addr_t *addr)
{
    size_t host_len;
    size_t wire_len;
...
int
ngx_stream_trojan_parse_udp_frame(const uint8_t *buf, size_t len, ngx_stream_mtrojan_udp_frame_t *frame)
{
    size_t pos;
    size_t wire_len;
...
int
ngx_stream_trojan_pack_udp_frame(const ngx_stream_mtrojan_addr_t *addr, const uint8_t *payload,
